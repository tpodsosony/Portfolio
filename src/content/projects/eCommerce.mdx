...
tags: ["Ruby", "Rails", "Google Cloud", "CRUD"]
info:
  - text: GitHub
...
The purpose of this was to develop a website containing CRUD using Rails gems. Developed entirely by me, the featured website focused on a fictional book store, named Crooks, that sells books at neigh unattainable prices.

![eCommerce website title page](../../assets/eCommerceProject/TitlePage.png)

Intentionally, this website was created with ease of management in mind, hence the CRUD aspect. An admin page is featured in which the store owner could add affect the databases that stored all book data, prices, and associated images. 
