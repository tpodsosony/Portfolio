...
If you want to modify the giscus colors, you can do so in the `public/styles/giscus.css` file. Alternatively,
you can change the `giscus.theme` option to one of the provided options by discus.
