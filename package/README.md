...
If you noticed that the third string (from line `117` - `125`) suspiciously looks a lot like JS, and you'd be correct! That is the code that gets injected into the virtual module that provides all of the code. This is also where you can see how your options are actually being brought into the virtual module itself.
